...
def init_struct():
    ...
    S.stations[0].title = "집에서 학원"
    S.stations[0].Id = "115846"
    S.stations[0].select_buslines = ["112"]
        
    S.stations[1].title = "학원에서 집"
    S.stations[1].Id = "115065"
    S.stations[1].select_buslines = ["112"]
